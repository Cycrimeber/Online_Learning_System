...
class Course
{
    ...
    // public function countLessons($exerciseID)
    // {
    //     $stmt = $this->conn->prepare("SELECT COUNT(LessonID) FROM tblexercise WHERE ExerciseID = ?");
    //     $stmt->bind_param("i", $exerciseID);
    //     $stmt->execute();
    //     $stmt->bind_result($count);
    //     $stmt->fetch();
    //     return $count; // Return the count of lessons
    // }
}
